(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('isomorphic-fetch'), require('url'), require('querystring'), require('events')) :
	typeof define === 'function' && define.amd ? define(['exports', 'isomorphic-fetch', 'url', 'querystring', 'events'], factory) :
	(factory((global['fetch-maker'] = {}),global.isomorphicFetch,global.url,global.qs,global.EventEmitter));
}(this, (function (exports,isomorphicFetch,url,qs,EventEmitter) { 'use strict';
